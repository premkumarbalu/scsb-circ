...
import org.recap.camel.route.DailyRRProcessor;
 ...
 */
public class DailyRRProcessorUT extends BaseTestCase {

    @PersistenceContext
    EntityManager entityManager;

    @Autowired
    DailyRRProcessor dailyRRProcessor;
    ...
    public void testCreateCell() throws Exception{
        ...
        dailyRRProcessor.createCell(xssfWorkbook,row,"test",0);
    ...
    public void testBuildRequestsRows() throws Exception{
        ...
        XSSFCellStyle xssfCellStyleForDate = dailyRRProcessor.getXssfCellStyleForDate(xssfWorkbook);
        dailyRRProcessor.buildRequestsRows(xssfWorkbook,testSheet,xssfCellStyleForDate,0, String.valueOf(requestItemEntity.getRequestId()));
        XSSFSheet test = xssfWorkbook.getSheet("test");
        XSSFRow testRow = test.getRow(0);
        assertNotNull(testRow);
        Cell cell0 = dailyRRProcessor.getRowValuesForCompare(testRow, 0);
        Cell cell1 = dailyRRProcessor.getRowValuesForCompare(testRow, 1);
        Cell cell2 = dailyRRProcessor.getRowValuesForCompare(testRow, 2);
        Cell cell3 = dailyRRProcessor.getRowValuesForCompare(testRow, 3);
        Cell cell4 = dailyRRProcessor.getRowValuesForCompare(testRow, 4);
        Cell cell7 = dailyRRProcessor.getRowValuesForCompare(testRow, 7);
        Cell cell8 = dailyRRProcessor.getRowValuesForCompare(testRow, 8);
        Cell cell9 = dailyRRProcessor.getRowValuesForCompare(testRow, 9);
        Cell cell10 = dailyRRProcessor.getRowValuesForCompare(testRow, 10);
        Cell cell11 = dailyRRProcessor.getRowValuesForCompare(testRow, 11);
    ...
    public void testBuildDeacessionRows() throws Exception{
        ...
        ItemEntity itemEntity = bibliographicEntity.getItemEntities().get(0);
        XSSFCellStyle xssfCellStyleForDate = dailyRRProcessor.getXssfCellStyleForDate(xssfWorkbook);
        dailyRRProcessor.buildDeacessionRows(xssfWorkbook,testSheet,xssfCellStyleForDate,0,itemEntity.getBarcode());
        XSSFSheet test = xssfWorkbook.getSheet("test");
        XSSFRow testRow = test.getRow(0);
        assertNotNull(testRow);
        Cell cell1 = dailyRRProcessor.getRowValuesForCompare(testRow, 1);
    ...
    public void testCompareLasAndScsbSheets() throws Exception{
        ...
        dailyRRProcessor.compareLasAndScsbSheets(xssfWorkbook);
