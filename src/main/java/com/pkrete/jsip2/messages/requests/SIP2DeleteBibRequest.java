 ...
 */
public class SIP2DeleteBibRequest extends SIP2CirculationTransactionRequest {

    private SIP2DeleteBibRequest(){
        super("85");
        this.itemIdentifier = "";
    ...
    public SIP2DeleteBibRequest(String staffIdentifier, String titleIdentififier, String itemIdIdentifier) {
        this();
    ...
    public SIP2DeleteBibRequest(String staffIdentifier, String titleIdentififier, String itemIdIdentifier,String bibId) {
        this();
        this.itemIdentifier = itemIdIdentifier;
        this.titleIdentifier =titleIdentififier;
        this.patronIdentifier=staffIdentifier;
